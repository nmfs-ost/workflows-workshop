...
When you run `asar::create_template()`, you'll see a glossary ("report_glossary.tex") in your "report" folder. Take a look at [the uploaded version, here](github.com/nmfs-ost/asar/blob/main/inst/glossary/report_glossary.tex).
...
For example, here is an entry for a survey known locally as "GOA acoustic survey", but administratively called "MACE Gulf of Alaska Pollock Acoustic Trawl_Summer": 

`\newacronym{goa acoustic survey}{GOA acoustic survey}{MACE Gulf of Alaska Pollock Acoustic Trawl_Summer}`

This text...

> In 2025, the `\gls{GOA acoustic survey}`...

...will render like this:

> In 2025, the MACE Gulf of Alaska Pollock Acoustic Trawl_Summer (GOA acoustic survey)...
