...
Welcome! Please open the [Day 1 communal notes doc](https://docs.google.com/document/d/1zxzu143BNOOsMjx1OoCs-Bj0chz_caHNpHb5jzCN9FM/edit?tab=t.0#heading=h.lwix6dbx3lr8) and participate in the icebreaker exercise.

::: {.callout-note}
**Discussion time:** What are some reservations or excitement you have surrounding this workshop or workflows as a whole?
:::
...
-   [Day 1 communal notes doc](https://docs.google.com/document/d/1zxzu143BNOOsMjx1OoCs-Bj0chz_caHNpHb5jzCN9FM/edit?tab=t.0#heading=h.lwix6dbx3lr8)
...
::: {.callout-note}
Let's look at our [article on markdown notation](https://nmfs-ost.github.io/asar/articles/markdown_notation.html)!
:::
...
So, why should you use Quarto to build reports?
...
::: {.callout-note}
Quarto is both a publishing platform *and* an R package ({quarto}). The R package provides a way to interact with the Quarto platform using R code instead of the terminal. For example, you can render a Quarto document with `quarto::quarto_render(my_quarto_doc.qmd)` or by typing `quarto render my_quarto_doc.qmd` in the terminal.
:::

### Let's open up a Quarto document!
...
* Format: Keep as HTML
* Engine: Keep as Knitr
* Editor: Uncheck "Use visual markdown editor" box

Click "Create" and open your Quarto document!
