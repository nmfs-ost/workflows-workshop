...
## Practice exercises: Foundational `create_template()` use cases
...
::: {.callout-caution collapse="true"}
## **Answers** for Practice exercises: Foundational `create_template()` use cases
...
```{r eval = FALSE}
"The species `r params$ps` was abundant throughout the study area."
```
