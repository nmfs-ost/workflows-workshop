...
First, navigate to your 'report' folder. Set it as your working directory. This is essential because, for this function to work, the folder containing your skeleton .tex file must be set as your working directory.

```{r eval = FALSE}
setwd(here::here("report"))
```

Next, use the `add_tagging()` function. 
