...
Welcome! Please open the [Day 3 communal notes doc](https://docs.google.com/document/d/1nVlmmZgp8vCHZKCMHnBm43bf-mtk7pSA1t2FLHEoyZA/edit?tab=t.vffehz79fm7y#heading=h.sfq3xaeehv64) and participate in the icebreaker exercise.
...
-   [Day 3 communal notes doc](https://docs.google.com/document/d/1nVlmmZgp8vCHZKCMHnBm43bf-mtk7pSA1t2FLHEoyZA/edit?tab=t.vffehz79fm7y#heading=h.sfq3xaeehv64)
...
If you have already converted your output: great! Import it into your R environment so that you can handle it as an object like "petrale" in the chunk above. For example:
...
::: callout-important
We are working on finishing the exporting capability of `table_landings()` so that it can export multiple tables if the user inputs multiple converted model outputs (i.e., a list of `dat` objects).
:::
...
Please navigate to this [EasyRetro board](https://easyretro.io/publicboard/3kNnwubT8rdQRy0M4aakmbQakcG3/592d2360-e8e0-4587-9aea-a92474d73bd5) and tell us what you thought about today's workshop. Only 3 simple questions!
