...
new_row <- data.frame(
  col1 = "abcde", # identical to the chunk label ("fig-abcde") MINUS "fig-"
  col2 = "figure",
  col3 = "my example figure caption",
  col4 = "my example figure alt text",
  stringsAsFactors = FALSE
)

# Add information to captions/alt text csv file as new row
write.table(new_row, 
