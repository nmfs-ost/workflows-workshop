...
::: {.callout-tip}
To identify what sections you can include from the standard guidelines, you can run `r 	
List of existing sections to include in the custom template. Note: this only includes sections within `list.files(system.file("templates", "skeleton", package = "asar"))`
