...
<!-- Add workflow tutorial here: asar -->
...
<!-- Add workflow tutorial here: stockplotr + putting it all together -->
...
<!-- Add practice exercise for making a SAR from start to finish (ask them to follow along with the tutorial?) -->
