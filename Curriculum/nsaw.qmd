...
Make sure to check through these quantities once you have a standard output! We have done our best to make this part of the template as flextible as possible, but some of the quantities like targets could be inaccruate for what you want for the stock. 
...
<!-- -making the plot show *relative* biomass (biomass relative to the ref line) AND changing linewidth to be bolder -->
<!-- We can change the linewidth because it's an argument associated with the line geom. If we set geom equal to another option- area, point- then we could use arguments from the ggplot functions geom_area, geom_point. -->
...
![](Day_3/images/day3_ex_table1.png)
