...
3. [Create a new Github repo](https://happygitwithr.com/rstudio-git-github.html#make-a-repo-on-github-1) for the workshop. Do not complete the last step ("12.7 Clean up").
