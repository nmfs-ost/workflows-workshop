...
2. Ensure you have downloaded [Quarto, version 1.6+ ](https://quarto.org/docs/get-started/), the `quarto` R package, and can create Quarto documents.
```{r eval=FALSE}
pak::pak("quarto")
quarto::quarto_version()
```

3. *Optional*: [Create a new Github repo](https://happygitwithr.com/rstudio-git-github.html#make-a-repo-on-github-1) for the workshop. Do not complete the last step ("12.7 Clean up"). First, [install Git](https://happygitwithr.com/install-git) if you don't have it.
4. *Optional*: [Clone your repo and set up an RStudio Project](https://happygitwithr.com/rstudio-git-github.html#clone-the-test-github-repository-to-your-computer-via-rstudio).
